...
def get_grid_start_end(parsed_input):
    grid, start, end, start_list = get_grid_st_en(parsed_input)
...
def get_grid_st_en(parsed_input):
    ...
    return grid, start, end, start_list
...
def solution_part_two(parsed_input):
    [grid, _, end, start_positions] = get_grid_st_en(parsed_input)
    ...
    for start in start_positions:
        ...
        if end in visited:
            amount_steps.append(visited[end])

    return min(amount_steps)


def solution_part_one_alternate(parsed_input):
    [grid, start, end, start_positions] = get_grid_st_en(parsed_input)
